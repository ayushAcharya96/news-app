package com.springfield.newsapp.adapters
...
class NewsAdapter : RecyclerView.Adapter<NewsAdapter.ArticleViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ArticleViewHolder, position: Int) {
        ivArticleImage = holder.itemView.findViewById(R.id.ivArticleImage)
        tvSource = holder.itemView.findViewById(R.id.tvSource)
        tvTitle = holder.itemView.findViewById(R.id.tvTitle)
        tvDescription = holder.itemView.findViewById(R.id.tvDescription)
        tvPublishedAt = holder.itemView.findViewById(R.id.tvPublishedAt)
